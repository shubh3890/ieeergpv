...
const Events = () => {
  return (
    <div className="pt-20 px-6 md:px-20 bg-gradient-to-r from-blue-100 via-indigo-100 to-blue-100">
      ...
      {/* Upcoming Events */}
      <h2 className="text-blue-900 mt-10 font-bold text-3xl text-left">
        Upcoming Events
      </h2>

      <div className="w-full mt-10 flex flex-wrap gap-6 justify-center pb-10">
        ...
        <div className="bg-blue-500/20 rounded-md px-10 pt-10 pb-5">
          ...
          <div className="w-full flex justify-between gap-4">
            <button className="text-white p-3 mt-6 rounded-md font-semibold bg-gradient-to-r from-yellow-600 to-orange-700 hover:scale-105 transition-all">
              Register
            </button>
